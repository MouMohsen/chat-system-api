...
ActiveRecord::Schema.define(version: 20190710000657) do
  ...
  create_table "chats", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["chat_number"], name: "index_chats_on_chat_number", unique: true, using: :btree
  end
  ...
  create_table "messages", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["message_number"], name: "index_messages_on_message_number", unique: true, using: :btree
  end
